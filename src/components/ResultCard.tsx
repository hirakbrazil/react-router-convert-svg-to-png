    ...
    <div className="border border-border bg-card dark:bg-card rounded-xl p-6 space-y-4">
      <div className="flex justify-between items-center">
        <div className="flex flex-wrap items-center gap-x-1">
          ...
          <InfoTooltip content="The total amount you will invest as a lump sum." />
        </div>
      ...
      <div className="flex justify-between items-center">
        <div className="flex flex-wrap items-center gap-x-1">
          ...
          <InfoTooltip content="The estimated returns generated by your lump sum investment over the investment period, shown both as an absolute value and as a percentage of your total investment." />
        </div>
